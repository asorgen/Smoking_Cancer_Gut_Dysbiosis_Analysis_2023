...
# BioLockJ.v1.4.2: ${scriptDir}/01.0_GenMod.sh
...
executeLine "Rscript ${modDir}/resources/CountConversion.R BLJ Abx-Bladder Abx-Colon Abx-Pancreatic Neo-Pancreatic NNK-FMT Smoke-FMT" ${LINENO}
