...
# BioLockJ v1.4.2: ${scriptDir}/MAIN_15_LinearModeling_Smoke-FMT_CasevCtrl.sh
...
touch "${scriptDir}/MAIN_15_LinearModeling_Smoke-FMT_CasevCtrl.sh_Started"
...
function spawnDockerContainer() {
    ...
    echo "${SCRIPT_ID}:docker:${containerId}" >> ${scriptDir}/MAIN_15_LinearModeling_Smoke-FMT_CasevCtrl.sh_Started
    docker inspect ${containerId}
}

function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_15_LinearModeling_Smoke-FMT_CasevCtrl.sh_Failures"
    exit ${3}
}
...
executeLine "spawnDockerContainer ${scriptDir}/15.0_GenMod.sh" ${LINENO}

touch "${scriptDir}/MAIN_15_LinearModeling_Smoke-FMT_CasevCtrl.sh_Success"
