...
# BioLockJ v1.4.2: ${scriptDir}/MAIN_13_PCoA_Smoke-FMT_DonorRecipient-CasevCtrl.sh
...
touch "${scriptDir}/MAIN_13_PCoA_Smoke-FMT_DonorRecipient-CasevCtrl.sh_Started"
...
function spawnDockerContainer() {
    ...
    echo "${SCRIPT_ID}:docker:${containerId}" >> ${scriptDir}/MAIN_13_PCoA_Smoke-FMT_DonorRecipient-CasevCtrl.sh_Started
    docker inspect ${containerId}
}

function scriptFailed() {
    echo "Line #${2} failure status code [ ${3} ]:  ${1}" >> "${scriptDir}/MAIN_13_PCoA_Smoke-FMT_DonorRecipient-CasevCtrl.sh_Failures"
    exit ${3}
}
...
executeLine "spawnDockerContainer ${scriptDir}/13.0_GenMod.sh" ${LINENO}

touch "${scriptDir}/MAIN_13_PCoA_Smoke-FMT_DonorRecipient-CasevCtrl.sh_Success"
